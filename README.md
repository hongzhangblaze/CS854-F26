...
|  | [Efficient Memory Management for Large Language Model Serving with PagedAttention](https://dl.acm.org/doi/10.1145/3600006.3613165) (Required) | Max Homm | Zhiang Wu |
...
|  | [KVCache Cache in the Wild: Characterizing and Optimizing KVCache Cache at a Large Cloud Provider](https://www.usenix.org/conference/atc25/presentation/wang-jiahao) (Required) | Hala Mukheimer |  Mu'men Al Jarah  |
|  | [FlexGen: High-Throughput Generative Inference of Large Language Models with a Single GPU](https://proceedings.mlr.press/v202/sheng23a.html) (Required) | Lingwei Gu | Jacob Youssef |
...
|  | [Distserve: Disaggregating Prefill and Decoding for Goodput-optimized Large Language Model Serving](https://www.usenix.org/system/files/osdi24-zhong-yinmin.pdf)  (required) | Haochen Gu | Omar Al-Saleh |
...
|  | [Towards High-Goodput LLM Serving with Prefill-decode Multiplexing](https://dl.acm.org/doi/10.1145/3779212.3790236) (Required) | Aima Shahid | Eyoel Matiwos |
...
| Oct 20 | **Parallelism** |  |  |
|  | [AlpaServe: Statistical Multiplexing with Model Parallelism for Deep Learning Serving](https://www.usenix.org/system/files/osdi23-li-zhuohan.pdf) (Required) | Tien Dat Nguyen   | Henry Zhang |
...
| Oct 27 | **Scheduling** |  |  |
|  | [Fast Distributed Inference Serving for Large Language Models](https://arxiv.org/pdf/2305.05920) (Required) | Henry Zhang | Tien Dat Nguyen  |
...
|  | [INFERCEPT: Efficient Intercept Support for Augmented Large Language Model Inference](https://arxiv.org/pdf/2402.01869) (Required) | Mark Ma | Max Homm |
...
|  | [DroidSpeak: KV Cache Sharing for Cross-LLM Communication and Multi-LLM Serving](https://arxiv.org/pdf/2411.02820) (Required) | Rikard Saqe | Mark Ma |
...
|  | [ServerlessLLM: Locality-Enhanced Serverless Inference for Large Language Models](https://arxiv.org/pdf/2401.14351)  (Required) | Naufal Wibawa  | Arsh Parmar |
...
|  | [Fairness in Serving Large Language Models](https://www.usenix.org/conference/osdi24/presentation/sheng) (Required) | Mohammad Zakout | Jerry Bao |
